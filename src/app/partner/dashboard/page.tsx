    ...
    return (
      <div className="min-h-screen flex flex-col bg-gray-50/70">
        ...
        <main className="flex-1 max-w-xl w-full mx-auto px-4 py-12 flex items-center justify-center">
          <div className="rounded-3xl bg-white p-8 text-center border border-pink-100/60 shadow-xs space-y-3">
            <span className="text-3xl block">❤️</span>
            <h1 className="text-lg font-bold text-gray-900">
              No Active Connection Found
            </h1>
            <p className="text-xs text-gray-500 leading-relaxed">
              Ask your partner to send you an invitation from their Herizon Partner Sync page to view shared updates.
            </p>
          </div>
        </main>
        <Footer />
